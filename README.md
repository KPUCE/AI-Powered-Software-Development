...
* AI는 디테일(detail)에 약하다. 디데일을 잘 채워주는 것이 매우 중요하다.
 ...
 * gpt5가 생성한 시스템 설계서 (https://github.com/KPUCE/AI-Powered-Software-Development/blob/main/docs/gptDBdesign-prompt.md)
